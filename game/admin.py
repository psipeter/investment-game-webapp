...
class User(UserAdmin):
	list_display = ('username', 'group', 'doneConsent', 'doneTutorial', 'doneRequired', 'doneBonus', 'doneHIT', 'doneCash', 'code', 'nRequired', 'nBonus', 'age', 'gender', 'income', 'education', 'veteran', 'empathy', 'risk', 'altruism')
